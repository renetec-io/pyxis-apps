...
if (typeof(pyxis) == "undefined") {
    ...
    pyxis.wlan = {
        ...
        connect(ssid, psk) {
            ...
            pyxis.plugins.system(wpaPrefix + `set_network ${net}`);
